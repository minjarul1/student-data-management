...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO library (book_name, author, borrowed_by, borrow_date, return_date, status) 
            VALUES ('$book_name', '$author', '$borrowed_by', '$borrow_date', '$return_date', '$status')";
...
<body>
    ...
    <div class="button-container">
        ...
        <a href="http://localhost/new_code/library,result.html">
